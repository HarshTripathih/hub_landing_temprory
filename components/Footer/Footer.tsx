...
export default function Footer() {
  return (
    <footer 
      id="contact"
      className="text-white relative w-full bg-[url('https://d1b9peg0jj5bry.cloudfront.net/Aliens_Hub_Landing/images/hero_bg-min.jpg')] bg-cover bg-center bg-no-repeat pb-10 md:pb-0 pt-16 md:pt-24 px-4 md:px-0 overflow-hidden">
